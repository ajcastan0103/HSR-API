...
- `GET /api/v1/characters/element/:element`: Get characters by element.
- `GET /api/v1/characters/path/:path`: Get characters by path name.
- `GET /api/v1/characters/rarity/:rarity`: Get characters by rarity(4 or 5).
